...
Change directory to the PTCLM folder. From there execute the buildtools script.
...
The -X argument is is to make sure tha X11 forwarding. 
...
The -A argument allows you to set your project number (in my case UBOI0006).
