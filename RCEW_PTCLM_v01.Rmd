...
The first step is to load the appropriate modules (i.e. packages and libraries). The module **ncl** (NCAR command language) is required to run some scripts. The Earth Systems Model Framework library (**esmf_lib/7.1.0r**) is needed to run some of the mkmap scripts. In order use **esmf_lib/7.1.0r** you should to use intel version 18.0.5 or 19.0.2.  
