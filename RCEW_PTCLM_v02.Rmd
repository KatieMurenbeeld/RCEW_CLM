...
Here is a list of references from this technical note.
...
Cheyenne environment variables list and information [link](http://www.cesm.ucar.edu/models/cesm2/settings/2.1.0/drv_input.html).

Coverting Ameriflux data, from CLM4.5 User's Guide  [link](https://www.cesm.ucar.edu/models/cesm1.2/clm/models/lnd/clm/doc/UsersGuide/x13434.html#AmeriFluxdata)
