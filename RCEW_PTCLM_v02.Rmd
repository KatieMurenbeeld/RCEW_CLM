...
In order to create a new case there are 3 required (and several optional) arguments: compset, res, and case. The compset... The res... The case... The other arguments used here are run-unsupported and project. The run-unsupported ... The project... If you are interested in the arguments please see the help documentation by running
...
Next, you will update the clm_user_nl (the CLM user namelist) file. In this file... You will set the surface data file to the surfdata file you created in section 3. 
