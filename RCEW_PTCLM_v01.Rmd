...
About the Community Terrestrial Systems Model (CTSM) and Community Land Model (CLM) explain how different although terms are used almost interchangably. Model simulations. Include a link to the escomp CLM5.0 and the CLM4.5 User's Guides. 
...
Notice that there is a folder within your project direcotry named manage_externals. This contains a very important script, checkout_externals. 
