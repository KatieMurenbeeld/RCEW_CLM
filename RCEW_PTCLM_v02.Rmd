...
More information can be found in [practical 1](https://www.cgd.ucar.edu/events/2019/ctsm/files/practical1-lombardozzi.pdf) from the above mentioned 2019 CTSM tutorial and of course in the "--help" documentation.
...
General steps (reference to Practical 4, slide 45 onwards)
...
5. build model
6. submit case (make sure to update STOP_N, REST_N, and RESUBMIT)
7. ./xmlchanges - 1901 - 1980 (maybe stop here??)
8. remove bin files from scratch case directory
9. Copy over user datm streams
10. submit case
11. ./xmlchange - post 1989 **especially RUN_REFCASE**
12. submite case
...
1. Create new case or clone
2. Go to newly created case directory
3. ./xmlchanges
4. case.setup --reset
5. ./xmlchanges and nl changes
6. Build the case
7. Copy over the rpointer and case files from the original case
8. Copy over the archive output files
9. Submit the case

## 6. Model Outputs

As noted in the above sections, model output lives in the 
